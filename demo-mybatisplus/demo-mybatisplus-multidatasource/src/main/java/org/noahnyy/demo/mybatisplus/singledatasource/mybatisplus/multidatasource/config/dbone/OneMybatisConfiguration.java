...
@MapperScan(
        ...
        basePackages = {"org.noahnyy.demo.mybatisplus.singledatasource.mybatisplus.multidatasource.mapper.dbone"}
)
public class OneMybatisConfiguration {
    ...
    private SqlSessionFactory getSqlSessionFactory(DataSource dataSource, PaginationInterceptor paginationInterceptor, @Nullable PerformanceInterceptor performanceInterceptor) throws Exception {
        ...
        sqlSessionFactory.setTypeAliasesPackage("org.noahnyy.demo.mybatisplus.singledatasource.mybatisplus.multidatasource.model.entity.dbone");
